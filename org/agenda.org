...
* Week 7: Parallelism, Review of Boolean logic, HDL (Oct 6, Oct 8)

- [ ] No Friday classes this week ("Hurkle-Durkle Day")!
- [ ] Test 6 is live (deadline Oct 12) - topics: OS files, networking.
- [ ] Graded assignments: submit missing, pay attention (or ask me).
- [ ] New assignment (deadline Oct 12) - Amdahl's law [review].
- [ ] Topics: Parallelism, Boolean Logic, Hardware Description

** TODO Review: Amdahl's law, network adapters
...
3. Amdahl's law example 1: You're designing a new CPU that is supposed
...
4. Name two programs that can be used to run programs remotely - how
