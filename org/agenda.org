...
** DONE Review (Wednesday) - Program Memory Layout
...
* Week 6: OS files, Amdahl's Law, Networks, Parallelism (Sep 29, Oct 1, Oct 3)
#+attr_html: :width 400px :float nil:
[[../img/week6.png]]

- [ ] *Correction*: ASLR does *not* protect hardware deterioration (it's a
...
- [ ] *Current assignment*: Remember to upload the ZIP file for the
  memory layout exploration exercise by October 3rd.

- [ ] *New assignment*: Reusing OS kernel file descriptors. Submit
  answers to a few questions after experimenting on the shell.

** IN PROGRESS OS files as I/O abstraction
...
** PRACTICE Amdahl's Law (Also: home assignment)
** Concurrency and parallelism  

** Summary: The Importance Of Being Earnest (when dealing with Abstractions)
#+attr_html: :width 400px :float nil:
[[../img/tiobe.png]]
...
* Week 7: Review of digital (Boolean) logic, Hardware Description Language (Oct 6, Oct 8)

- No Friday classes this week ("Hurkle-Durkle Day")!
